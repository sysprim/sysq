            ...
            <div class="row">
                <div class="col s12">
                            <ul class="tabs">
                                ...
                                <li class="tab col s12 m6"><a href="#taquilla" style="color:blue">Taquillas</a></li>
                            </ul>                
                    

                    <div class="collection with-header" id="usuario">
                ...
                <div class="collection with-header" id="taquilla">
                        <div class="collection-header"><h5>Usuarios Registrados</h5></div>
